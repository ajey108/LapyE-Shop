    ...
    <div className="container mx-auto py-10 px-4 bg-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-gray-600">We offer a hassle-free exchange policy for your convenience. If you're not satisfied, you can easily exchange your product within 30 days.</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-gray-600">Your transactions are secured with end-to-end encryption, ensuring that your data remains safe and protected at all times.</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-gray-600">Our dedicated customer support team is available 24/7 to assist you with any queries or issues you may have.</p>
        </div>
      </div>
    </div>
  )
