...
const About = () => {
  return (
    <div className="">
      <div className=" dark:text-white text-2xl  text-center pt-8 border-t">
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className=" dark:text-white flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          ...
          <p>
            At TechWorld, our mission is to empower users with top-tier laptops
            that cater to their specific needs. From powerful processors to
            sleek designs, we offer only the best in modern computing, ensuring
            you find the perfect device with ease and confidence.
          </p>
        </div>
      </div>

      <div className=" dark:text-white text-xl text-center py-4">
        <Title text1={"WHY"} text2={"CHOOSE US"} />
      </div>

      <div className=" dark:text-white flex flex-col md:flex-row text-sm mb-20">
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Expert Selection:</b>
          <p className=" ">
            Our team of tech experts carefully selects each laptop, ensuring top
            performance and value for every budget.
          </p>
        </div>
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Seamless Shopping:</b>
          <p className=" ">
            With our easy-to-navigate platform and fast checkout process,
            finding and purchasing the right laptop has never been simpler.
          </p>
        </div>
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Unmatched Customer Support:</b>
          <p className=" ">
            Our dedicated customer support team is here to guide you, offering
            expert advice and ensuring your satisfaction every step of the way.
          </p>
        </div>
      </div>
