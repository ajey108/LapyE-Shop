...
const PlaceOrder = () => {
  ...
  return (
    <form
      ...
      className="flex dark:text-white flex-col sm:flex-row justify-between gap-4 mt-28 pt-5 sm:pt-14 min-h-[80vh]"
    >
      {/* Left Side */}
      ...
      <div className="mt-8 dark:text-white ">
        ...
        <div className="mt-10 w-full flex justify-end mb-2">
          <button
